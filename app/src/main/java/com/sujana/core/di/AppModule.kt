...
// Hilt DI module — activated in Stage 1 once hilt.android Gradle plugin is wired.
// All @Module / @Provides / @Singleton annotations are present and correct;
// they just won't be processed until the plugin is enabled.

import com.sujana.BuildConfig
import com.sujana.core.network.AuthInterceptor
